...
class Constants:
    ...
    CODEBOOK_CONSTRAINED_COL = "constrained"
    CODEBOOK_COLS = [CODEBOOK_NAME_COL, CODEBOOK_TYPE_COL, CODEBOOK_OBSERVABILITY_COL, CODEBOOK_OBSERVABILITY_COL_V2, CODEBOOK_CONSTRAINED_COL]
